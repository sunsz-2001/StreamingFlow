...
def set_cfg():
    ...
    _C.IMAGE = CN()
    _C.IMAGE.FINAL_DIM = (240, 360)
    _C.IMAGE.RESIZE_SCALE = 0.5
    _C.IMAGE.TOP_CROP = 0
    _C.IMAGE.ORIGINAL_HEIGHT = 640  # Original input RGB camera height
    _C.IMAGE.ORIGINAL_WIDTH = 480  # Original input RGB camera width
