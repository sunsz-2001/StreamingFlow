"""
GRU-ODE Cell implementations for continuous-time modeling.

These cells implement the GRU-ODE dynamics for handling continuous-time state evolution.
"""
...
class SpatialGRUODECell(torch.nn.Module):
    """Spatial GRU-ODE Cell for continuous-time state evolution."""
...
class DualGRUODECell(torch.nn.Module):
    """Dual GRU-ODE Cell for advanced continuous-time modeling."""
    ...
    def forward(self, x, state):
        ...
        return cur_state - state[:, -1]  # Use last state for comparison
