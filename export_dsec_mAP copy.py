...
def parse_args():
    ...
    parser.add_argument("--checkpoint", default='/home/user/sunsz/StreamingFlow/logs/dsec_event_lidar_eval_1/epoch=10-step=23099.ckpt', help="Path to model checkpoint (.ckpt).")
    ...
    parser.add_argument("--score-thr", type=float, default=0.2, help="Score threshold for filtering predictions (0.0 means no filtering).")
